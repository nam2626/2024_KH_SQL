...
SELECT DENSE_RANK() OVER(ORDER BY EMP_SALARY desc) AS SALARY_RANK,
	EMP_NO, EMP_NAME, EMP_POSITION, EMP_DEPARTMENT, 
	TO_CHAR(EMP_SALARY,'FM999,999,999') AS EMP_SALARY, 
